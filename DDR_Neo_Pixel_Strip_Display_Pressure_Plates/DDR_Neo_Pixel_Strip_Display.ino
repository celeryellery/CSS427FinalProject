...
void checkPlayerInput()
{
  ...
  if (!isRedButtonPressed)
  {
    ...
    isRedButtonPressed = totalred > stepThreshhold;
  }
  if (!isGreenButtonPressed)
  {
    totalgreen =  cs_red.capacitiveSensor(30);
    Serial.print("Value1: ");
    Serial.println(totalgreen);
    isGreenButtonPressed = totalgreen > stepThreshhold;
  }
  if (!isBlueButtonPressed)
  {

    isBlueButtonPressed = totalblue > stepThreshhold;
  }
